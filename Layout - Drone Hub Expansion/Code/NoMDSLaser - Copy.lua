...
function OnMsg.ClassesPostprocess()
	if BuildingTemplates.Drone Hub Expansion then
		return
	end

if 1==1 then
	PlaceObj("BuildingTemplate", {
		"Id", "Drone Hub Expansion",
		"LayoutList", "Drone Hub Expansion",
...
--~Pipes
	...
	PlaceObj("BuildingTemplate", {
		"Id", "Drone Hub Expansion with MDSLaser",
		"LayoutList", "Drone Hub Expansion with MDSLaser",
		"Group", "Infrastructure",
		"build_category", "Infrastructure",
